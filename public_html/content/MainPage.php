    ...
    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 g-4">
        <div class="col">
            <?php include_once("infocard-summary.php");?>
            <?php include_once("plates.php");?>
        </div>
        <div class="menu-lk col">
            <nav class="nav nav-pills shadow-box-st mb-2" id="pills-tab" role="tablist">
                ...
                <a class="nav-link" id="pi lls-competencies-tab" data-bs-toggle="pill" href="#pills-competencies" role="tab" aria-controls="pills-competencies" aria-selected="false">Компетенции</a>
