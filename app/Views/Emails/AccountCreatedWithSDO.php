<div style="background-color: #f5f5f5;padding:2rem;">
    <div style="background-color: #fefefe; margin: 0 auto; padding:1rem 2rem; text-align: center; border-radius: .75rem; max-width: 50rem">
        ...
        <section>
            <p>
                На нашем портале и системе дистанционного обучения для Вас создана учетная запись.<br>
            ...
            <p>
                <a href="https://ach.mgu-mlt.ru" style="display: inline-block; padding-right: 20px">Портал</a>
                <a href="https://do.mgu-mlt.ru" style="display: inline-block; padding-right: 20px">СДО Moodle</a>
            </p>
            <p>
